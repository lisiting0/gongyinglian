...
layer.config({
	...
	$("#side-menu").metisMenu(), $(".right-sidebar-toggle").click(function() {
		...
		if($('.navbar-minimalize i').is('.fa-arrows-alt')) {
			$(".navbar-minimalize i").removeClass('fa-arrows-alt').addClass('fa-crosshairs');
		} else {
			$(".navbar-minimalize i").removeClass('fa-crosshairs').addClass('fa-arrows-alt');
		}
